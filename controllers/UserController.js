...
exports.register = async (req, res) => {
    try {
        ...
        const emailOptions = {
            email: email,
            subject: 'Welcome to Mama Lovely Toy - Verification Code Inside',
            message: `
              <html>
                <head>
                  <style>
                ...
                <body>
                  <div class="container">
                    <div class="header">
                      <h2>Welcome to Mama Lovely Toy</h2>
                    </div>
                    <div class="content">
                      ...
                      <p>Thank you for joining us at Mama Lovely Toy. If you have any questions, feel free to contact our support team.</p>
                    </div>
                    <div class="footer">
                      &copy; ${new Date().getFullYear()} Mama Lovely Toy. All rights reserved.
                    </div>
                  </div>
                </body>
              </html>
...
exports.verifyOtpForSignIn = async (req, res) => {
    try {
        ...
        if (existingUserByMail.OtpForVerification === otps ) {
            ...
            const emailOptions = {
                email: email,
                subject: 'Welcome to Mama Lovely Toy - Verification Successful',
                message: `
                  <html>
                    <head>
                      <style>
...
exports.ResendSignOtp = async (req, res) => {
    try {
        ...
        const options = {
          email: email,
          subject: "Mama Lovely Toy Sign In OTP Request - Resend OTP",
          message: `
            <html>
              <head>
                <style>
              ...
              <body>
                <div class="container">
                  <div class="header">
                    <h2>Mama Lovely Toy Sign In OTP Request - Resend OTP</h2>
                  </div>
                  <div class="content">
...
exports.PasswordChangeRequest = async (req, res) => {
    try {
        ...
        const options = {
          email: email,
          subject: "Mama Lovely Toy Password Reset Request",
          message: `
            <html>
              <head>
                <style>
